...
import type { CableKind } from './Cable';

export default { title: 'Composites/Cable' };
...
export const SelectedAndBundled: Story = () => (
    <Stage>
...
export const SignalLevels: Story = () => (
    <Stage>
